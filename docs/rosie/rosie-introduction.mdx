...
<SimpleGrid columns={{base: 1, md: 2}} spacing={6}>
  <Card>
    ...
    <Link isExternal size="sm" variant="primary" href="http://app.codiga.io/hub/tutorial/ast-rules/get-started/">
      Play Tutorial
    </Link>
  </Card>
  ...
  <Card>
    ...
    <Link isExternal size="sm" variant="primary" href="http://app.codiga.io/hub/tutorial/pattern-rules/get-started/">
      Play Tutorial
    </Link>
  </Card>
</SimpleGrid>
